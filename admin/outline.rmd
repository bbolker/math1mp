# MATH 1MP3: Introduction to mathematical and scientific programming: Winter 2016
...
* *Teaching assistant*: Dexter Barrows (`barrowdd@mcmaster.ca`). When emailing, *please allow at least one full business day for responses.* Please note also that **the TA may not respond to emails sent less than 24hrs before an exam, assignment, or project is due.** The primary time to get help is during tutorial but, time permitting, the TA may be available for extra help outside of that hour.

## Lectures

* T, Th, F 11:30-12:20 (HH 302)

## Labs and assignments

* T 12:30-13:20, Th 13:30-14:20 KTH B123
* Labs start on Tuesday 5 Jan.  They will be used primarily for help and review, not for presenting new material (any exceptions will be noted).
...
* Assignments (20% home, 10% in-class)
* Final project (20%)
* Midterm test (20%)
...
1. Go to http://www.tcgo1.com OR http://www.tcgo2.com
2. Click `"Register for CodeLab"`
3. choose `"I am a student in a course ..."` and click `CONTINUE`
4. enter the Section Access Code: **MCM-22458-GHKN-27** and click `CONTINUE`
...
Once registered, students can submit solutions to 0 exercises.

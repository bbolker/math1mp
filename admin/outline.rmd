...
6. enter the Section Access Code: **MCMA-27272-MRAT-42** and click `Next>` and confirm.
...
4. Follow the payment directions (options include PayPal/credit card, money order, and payment keys). The cost is $25USD.
...
All assignments are due on Avenue to Learn prior to class, unless otherwise stated. We will penalize late work by 25% per day.

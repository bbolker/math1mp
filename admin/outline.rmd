...
- Tutorials will start **Monday 9 September**.  They will be used primarily for help and review, not for presenting new material (any exceptions will be noted).
- Some assignments will use [CodeLab](http://www.turingscraft.com/index.php).  Other assignments, approximately weekly, will be submitted in a dropbox on Avenue to Learn (AtL).  You need to register for (and pay for) CodeLab; see [instructions below](#codelab).
     - There will be approximately 4 quizzes during the semester.
...
## <a name="codelab"></a>CodeLab information
...
- If you use pencil we will not adjust your marks after you have taken your test away. In this case we suggeest that you take photos of your work to review and leave the test with a TA; then you can have your mark adjusted later.
...
Contact Dr. Bolker as soon as possible. Failing that, contact the Associate Dean's Office in BSB 129.

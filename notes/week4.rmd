...
- Mathematically this kind of example is called [**composition**](https://www.scaler.com/topics/association-composition-and-aggregation-in-java/) of a function with itself (see [Wikipedia](https://en.wikipedia.org/wiki/Function_composition)

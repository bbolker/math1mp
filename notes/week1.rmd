...
- We recommend that you use PyCharm to write your programs and test things out.
    - You can find the PyCharm installer [here](https://www.jetbrains.com/pycharm/download/). **The first time you run PyCharm, make sure you choose some version of python 3 from the drop-down menu**

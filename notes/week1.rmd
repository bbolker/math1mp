...
* Everyone must have access to a computer with Python3 installed
    * Here are detailed instructions for installing Python3
        * [On Windows](https://pragprog.com/book/gwpy2/practical-programming#windows)
        * [On Mac OS X](https://pragprog.com/book/gwpy2/practical-programming#osx)
        * [On Linux](https://pragprog.com/book/gwpy2/practical-programming#linux)
        * On Mac and Linux, once Python3 is installed you can run it directly from the Terminal by typing python3. On Windows, go to the Start menu and find Python3.

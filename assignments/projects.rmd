...
- given the results of `cb_sim()` (a tuple of numbers infected per `cb_tot(r)` counts the total number infected in an epidemic, that is the sum of the values in the tuple: for example, `cb_tot((1,2,1))` should return 4.

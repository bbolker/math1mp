...
1. Write a function `calc_frac(a,axis=0)` that takes a 2-dimensional numpy array containing only zeros and ones and returns an array giving the fraction of ones in each column (if `axis=0`) or in each row (if `axis=1`).
